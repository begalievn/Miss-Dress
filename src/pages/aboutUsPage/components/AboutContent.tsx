      ...
      {data.map((item, index) => (
        <div key={index} className={classes.container}>
          <div className={classes.title1}>
            <h1 className={classes.title_text}> {item.header1}</h1>{" "}
            <p className={classes.description1}>{item.description1}</p>
          </div>
          ...
          <div className={classes.block2}>
            <div className={classes.title2}>
              <h1 className={classes.text_font}> {item.header2}</h1>
              <p className={classes.description2}>{item.description2}</p>
            </div>
          ...
          <div className={classes.title3}>
            <h1 className={classes.text_font}> {item.header3}</h1>{" "}
            <p className={classes.description3}>{item.description3}</p>
          </div>
          ...
          <div className={classes.title4}>
            <h1 className={classes.text_font}> {item.header4}</h1>{" "}
            <p className={classes.description4}>{item.description4}</p>
          </div>
        </div>
      ))}
    </>
