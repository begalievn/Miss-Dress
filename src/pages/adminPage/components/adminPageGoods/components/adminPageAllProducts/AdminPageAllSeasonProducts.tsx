...
function AdminPageAllSeasonProducts() {
...
//   console.log(cards);
  ...
  return (
    ...
    //       <h5 className={classes.subtitle}>{cards.phoneNumber}</h5>
    //     </div>
    //     <div>
    //       <h4>Продажи</h4>
    //       <h5 className={classes.subtitle}>{cards.id} продаж</h5>
    //     </div>
    //     <div>
    //       <h4>Доход</h4>
    //       <h5 className={classes.subtitle}>{cards.id}k+ доход</h5>
    //     </div>
